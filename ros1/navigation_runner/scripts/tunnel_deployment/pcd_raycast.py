...
Replaces the C++ occupancy_map/raycast service which suffers from
sensor-update interference (the online raycastUpdate + cleanLocalMap
cycle wipes out the prebuilt PCD data).
...
lidar beam — matching the C++ getRayCast() API exactly.
"""
