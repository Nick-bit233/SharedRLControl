...
class EnvTunnelLagrangian(IsaacEnv):
    ...
    def __init__(self, cfg, trajectory_dataset: Optional[TrajectoryDataset] = None):
        print("[Navigation Environment]: Initializing Tunnel Lagrangian Env...")
        ...
        with torch.device(self.device):
            ...
            self.safety_cost = torch.zeros(self.num_envs, 1)
            self.min_dist_to_obs = torch.full((self.num_envs, 1), self.lidar_range)
    ...
    def _set_specs(self):
        ...
        stats_spec = Composite({
            ...
            "diag_safety_cost": Unbounded(1),
            "diag_min_dist_to_obs": Unbounded(1),
    ...
    def _reset_idx(self, env_ids: torch.Tensor):
        ...
        self.safety_cost[env_ids] = 0.
        self.min_dist_to_obs[env_ids] = self.lidar_range
    ...
    def _compute_state_and_obs(self):
        ...
        self.stats["diag_safety_cost"] = self.safety_cost
        self.stats["diag_min_dist_to_obs"] = self.min_dist_to_obs
    ...
    def set_camera_view_mode(self, mode: str):
        ...
        print(f"[EnvTunnelLagrangian] Camera view mode set to: {mode}")
