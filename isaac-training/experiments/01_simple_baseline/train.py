...
# Updated imports to use 'src' package
...
def main(cfg):
    ...
    from src.envs.env_simple import FollowingEnvSimple
    from src.algos.ppo_simple import SimplePPO
    ...
    if profiling_mode:
        ...
        # (See configs/experiment/simple_baseline.yaml)
        
        # Calculate total frames: frames_per_batch * num_envs * total_batches
        max_iterations = cfg.get("max_iterations", 2010)
        cfg.max_frame_num = cfg.algo.training_frame_num * cfg.env.num_envs * max_iterations
