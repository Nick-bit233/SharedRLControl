...
def find_latest_output_dir(stage_name: str) -> str:
    ...
    # Hydra outputs go to ./outputs/curriculum_stageN/<timestamp>/
...
def run_stage(
    ...
    # Stage configs write to outputs/curriculum_stageN/<timestamp>/
    output_base = f"curriculum_stage{stage_num}"
