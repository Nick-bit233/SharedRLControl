...
def main(cfg):
    ...
    # resume_checkpoint: continue the same run if the checkpoint contains
    # optimizer/iteration state; init_checkpoint: warm-start a new stage/run.
    ...
    if init_ckpt is not None:
        ...
        policy_state, _ = load_policy_state(resume_ckpt)
        policy.load_state_dict(policy_state)
